...
import org.simpleds.metadata.RelationIndexMetadata;
...
public class EntityManagerImpl implements EntityManager {
	...
	@Override
	@SuppressWarnings("unchecked")
	public <T extends Collection> T getRelationIndex(Key entityKey, String indexName) {
		ClassMetadata metadata = repository.get(entityKey.getKind());
		RelationIndexMetadata relationIndex = metadata.getRelationIndex(indexName);
		try {
	...
	@Override
	public void setRelationIndex(Key entityKey, String indexName, Collection<?> indexValue) {
		ClassMetadata metadata = repository.get(entityKey.getKind());
		RelationIndexMetadata relationIndex = metadata.getRelationIndex(indexName);
